...
from esphome.components import api  # <-- needed for CustomAPIDevice

k1_alarm_listener_ns = cg.esphome_ns.namespace("k1_alarm_listener")
K1AlarmListener = k1_alarm_listener_ns.class_("K1AlarmListener", cg.Component, api.CustomAPIDevice)

CONF_ALARM_ENTITY = "alarm_entity"

# Ensure api: is present in YAML
DEPENDENCIES = ["api"]
